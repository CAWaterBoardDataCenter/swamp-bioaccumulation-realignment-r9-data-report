...
+=============================+===================================================================================================================================+
| Bend                        | [Bend]{.underline} Genetics Laboratories                                                                                          |
+-----------------------------+-----------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------+-----------------------------------------------------------------------------------------------------------------------------------+
| MLML                        | [M]{.underline}oss [L]{.underline}anding [M]{.underline}arine [L]{.underline}aboratories                                          |
+-----------------------------+-----------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------+-----------------------------------------------------------------------------------------------------------------------------------+
| SGS-Axys                    | [SGS-Axys]{.underline} Laboratories                                                                                               |
+-----------------------------+-----------------------------------------------------------------------------------------------------------------------------------+
...
This data report presents the methods and analytical results of tissue and water samples that were collected in May - October 2022, and invertebrate samples that were collected in `XYZ - XYZ`; a total of ten locations were sampled (Figure 1).
...
Sampling crews were able to successfully collect fish and shellfish from six coastal locations, two lake or reservoir locations, and two river locations within the San Diego Region (Figure 1, Table 1).
...
Sample locations were accessed by boat, when possible, or from shore. Fish were collected by electrofisher boat (freshwater only), hook-and-line, trawling and other nets (beach seine, gill net, cast net). Invertebrate samples were collected by `XYZ`.

## Sample Preparation and Analytical Methods

Fish tissue and water samples were processed and distributed to the analytical laboratories as described in the Monitoring Plan by personnel at Moss Landing Marine Laboratories (MLML) in Moss Landing, CA. Table 2 summarizes which analytes were assessed for each location and species collected.
...
: Table 2. Summary of assessed analytes by location and species collected.

Mercury and selenium levels in tissue were analyzed by MLML; organics levels in tissue (PCBs, PFAS) were analyzed by SGS-Axys Laboratories (SGS-Axys); cyanotoxin levels in water samples were analyzed by Bend Genetics Laboratories (Bend).

Analytes (e.g., Mercury, PFAS) included in analyses, detection limits, as well as numbers of observations and frequencies of detection and reporting, are provided in Appendix A. All concentrations are reported on a wet weight basis. Moisture data are available, along with the entire dataset, via the [California Environmental Data Exchange Network](http://www.ceden.org/) (CEDEN).

## Data Management

The complete dataset for this study includes quality assurance data (quality control samples and field duplicates) and additional ancillary information (specific location information, fish sex, weights, and other information). The complete dataset is available in [CEDEN](http://www.ceden.org/find_data_page.shtml) and the [California Open Data Portal](https://data.ca.gov/dataset/surface-water-aquatic-organism-tissue-sample-results). The data can also be explored and downloaded via the [SWAMP Data Dashboard](https://gispublic.waterboards.ca.gov/swamp-data/). For more details on the entire data management cycle for the Program's bioaccumulation monitoring data, see the [General Bioaccumulation Data Use Frequently Asked Questions Webpage](https://cawaterboarddatacenter.github.io/stew-faq/other-faq/data-use-faq.html).
...
In the following sections, we summarize results by analyte and then by each sampling location. A concise tabular summary of the data for each sampling location is provided in Appendix B.
...
Data for mercury analyses on individual fish are provided in Appendix C. Data for PFAS analyses are provided in Appendix D.
...
# Appendix A. Analytes included in the 2019 lakes sampling, detection limits, number of observations, and frequencies of detection and reporting.

+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| Laboratory | Analyte Type | Analyte       | Method Detection Limit | Unit    | Number of Observations | Frequency of Detection (%) | Frequency of Reporting (%) |
+============+==============+===============+========================+=========+========================+============================+============================+
| MLML       | Metals       | Mercury       | 0.0030                 | 𝜇g/g ww |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| MLML       | Metals       | Selenium      | 0.2300                 | 𝜇g/g ww |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| MLML       | Metals       | Aresnic       |                        | 𝜇g/g ww |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| SGS-Axys   | Organics     | OC Pestacides |                        |         |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| SGS-Axys   | Organics     | PBDEs         |                        |         |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| SGS-Axys   | Organics     | PCB           |                        |         |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| SGS-Axys   | Organics     | PFAS          |                        |         |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+
| Bend       | Algal Toxins | Cyanotoxin    |                        |         |                        |                            |                            |
+------------+--------------+---------------+------------------------+---------+------------------------+----------------------------+----------------------------+

# Appendix ?. Summary of fish and shellfish results for the San Diego Region Realignment: composites or means at each location.
